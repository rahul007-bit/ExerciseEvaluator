...
package com.example.exerciseevaluator.utils;
...
public class CameraSource {
  ...
  public static final int DEFAULT_REQUESTED_CAMERA_PREVIEW_WIDTH = 1024;
  public static final int DEFAULT_REQUESTED_CAMERA_PREVIEW_HEIGHT = 768;
